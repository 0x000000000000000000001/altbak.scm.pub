...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_HeytingAlgebra_heytingAlgebraBoolean': $v = (object)["ff" => false, "tt" => true, "implies" => (function() use (&$__fn) {
...
$GLOBALS['Data_HeytingAlgebra_boolConj'] = $ffi_Data_HeytingAlgebra['boolConj'] ?? null;
$GLOBALS['Data_HeytingAlgebra_boolDisj'] = $ffi_Data_HeytingAlgebra['boolDisj'] ?? null;
$GLOBALS['Data_HeytingAlgebra_boolNot'] = $ffi_Data_HeytingAlgebra['boolNot'] ?? null;
